...
local rows_with_proxies = { "NoteSkin", "NoteSkinVariant", "JudgmentGraphic", "HeldGraphic", "ComboFont", "HoldJudgment", "JudgmentAnimation", "HoldAnimation", "HeldAnimation", "ComboAnimation", "MusicRate" }
...
for player in ivalues( GAMESTATE:GetHumanPlayers() ) do
	...
	proxy.RefreshActorProxyMessageCommand=function(self, params)
		...
		if optrow and optrow:GetName() == params.Name then
			...
			elseif params.Name=="JudgmentAnimation" or params.Name=="HoldAnimation" or params.Name=="HeldAnimation" or params.Name=="ComboAnimation" then
